...
require_once 'DangerousHTMLTagsFilter.php';
require_once 'MarkdownFormat.php';
require_once 'PlainTextFilter.php';

use Decorator\TextFormat\iText;
use Decorator\TextFormat\Text;
use Decorator\TextFormat\DangerousHTMLTagsFilter;
use Decorator\TextFormat\MarkdownFormat;
use Decorator\TextFormat\PlainTextFilter;
 ...
 */
function displayCommentAsAWebsite(iText $format, string $text)
{
